...
| `robots.follow` | `bool` | `true` | Allows crawlers to follow links on pages. Can be overriden in global or page-specic settings from the panel. Requires `robots` option to be `true` for having an effect. |
